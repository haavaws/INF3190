...
def Config(net, args):
    ...
    sleep(1)
    A.cmd('xterm -T "Serv A 80" -e ./server tpA 80 &')
    A.cmd('xterm -T "Serv A 90"  -e ./server tpA 90 &')
    ...
    sleep(1)
    B.cmd('xterm -T "Serv B 80"  -e ./server tpB 80&')
    ...
    sleep(1)
    D.cmd('xterm -T "Serv D 80"  -e ./server tpD 80 &')
    ...
    sleep(1)
    E.cmd('xterm -T "Serv E 80"  -e ./server tpE 80 &')
    sleep(1)
    E.cmd('xterm -T "Client E 10 90" -e ./client tpE 10 90 mip.c &')
    A.cmd('xterm -T "Client A 100 80" -e ./client tpA 100 80 mip.c &')
    B.cmd('xterm -T "Client B 10 80" -e ./client tpB 10 80 mip.c &')
    B.cmd('xterm -T "Client B 10 90" -e ./client tpB 10 90 mip.c &')
    C.cmd('xterm -T "Client C 30 80" -e ./client tpC 30 80 mip.c &')
    C.cmd('xterm -T "Client C 10 90" -e ./client tpC 10 90 mip.c &')
    C.cmd('xterm -T "Client C 100 80" -e ./client tpC 100 80 mip.c &')
    D.cmd('xterm -T "Client D 10 80" -e ./client tpD 10 80 mip.c &')
    D.cmd('xterm -T "Client D 100 80" -e ./client tpD 100 80 mip.c &')
    E.cmd('xterm -T "Client E 10 80" -e ./client tpE 10 80 mip.c ')
